          ...
          >
            <SwiperSlide>
              <div className="d-flex justify-content-between align-items-center py-2 px-3">
                <img
                  className="pe-3"
                  src={require("../images-compressed/logo-01.png")}
                  alt="img"
                />
            ...
            <SwiperSlide>
              <div className="d-flex justify-content-between align-items-center py-2 px-3">
                <img
                  className="pe-3"
                  src={require("../images-compressed/logo-02.png")}
                  alt="img"
                />
            ...
            <SwiperSlide>
              <div className="d-flex justify-content-between align-items-center py-2 px-3">
                <img
                  className="pe-3"
                  src={require("../images-compressed/logo-03.png")}
                  alt="img"
                />
            ...
            <SwiperSlide>
              <div className="d-flex justify-content-between align-items-center py-2 px-3">
                <img
                  className="pe-3"
                  src={require("../images-compressed/logo-04.png")}
                  alt="img"
                />
            ...
            <SwiperSlide>
              <div className="d-flex justify-content-between align-items-center py-2 px-3">
                <img
                  className="pe-3"
                  src={require("../images-compressed/logo-05.png")}
                  alt="img"
                />
            ...
            <SwiperSlide>
              <div className="d-flex justify-content-between align-items-center py-2 px-3">
                <img
                  className="pe-3"
                  src={require("../images-compressed/logo-06.png")}
                  alt="img"
                />
          ...
          >
            <SwiperSlide>
              <div className="d-flex justify-content-between align-items-center py-2 px-3">
                <img
                  className="pe-3"
                  src={require("../images-compressed/logo-07.png")}
                  alt="img"
                />
            ...
            <SwiperSlide>
              <div className="d-flex justify-content-between align-items-center py-2 px-3">
                <img
                  className="pe-3"
                  src={require("../images-compressed/logo-08.png")}
                  alt="img"
                />
            ...
            <SwiperSlide>
              <div className="d-flex justify-content-between align-items-center py-2 px-3">
                <img
                  className="pe-3"
                  src={require("../images-compressed/logo-09.png")}
                  alt="img"
                />
            ...
            <SwiperSlide>
              <div className="d-flex justify-content-between align-items-center py-2 px-3">
                <img
                  className="pe-3"
                  src={require("../images-compressed/logo-10.png")}
                  alt="img"
                />
            ...
            <SwiperSlide>
              <div className="d-flex justify-content-between align-items-center py-2 px-3">
                <img
                  className="pe-3"
                  src={require("../images-compressed/logo-11.png")}
                  alt="img"
                />
                <h6 className="text-white m-0">Red Oak Realty</h6>
              </div>
            ...
            <SwiperSlide>
              <div className="d-flex justify-content-between align-items-center py-2 px-3">
                <img
                  className="pe-3"
                  src={require("../images-compressed/logo-13.png")}
                  alt="img"
                />
                <h6 className="text-white m-0">American Home Agents</h6>
              </div>
            ...
            <SwiperSlide>
              <div className="d-flex justify-content-between align-items-center py-2 px-3">
                <img
                  className="pe-3"
                  src={require("../images-compressed/logo-12.png")}
                  alt="img"
                />
                <h6 className="text-white m-0">UA real estate agency</h6>
              </div>
